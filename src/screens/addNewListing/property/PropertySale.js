...
const PropertySale = ({navigation, route}) => {
  ...
  return (
    <SafeAreaView style={[styles.pdh16]}>
      ...
      <ScrollView style={[styles.pdt12]} showsVerticalScrollIndicator={false}>
        ...
        <DropDown
          defaultValue={forEdit ? itemData?.liftAvailable : 'Plese select...'}
          options={['Yes', 'No']}
          titleStyle={[styles.ts17, styles.fw400]}
        ...
        <DropDown
          defaultValue={
            forEdit ? itemData?.parkingAvailable : 'Plese select...'
          }
          options={['Yes', 'No']}
          titleStyle={[styles.ts17, styles.fw400]}
